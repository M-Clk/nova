    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    SaleNo = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Brands",
                columns: new[] { "Id", "Name" },
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), "Genel" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Name", "ParentId" },
                values: new object[] { new Guid("22222222-2222-2222-2222-222222222222"), "Genel", null });

            migrationBuilder.InsertData(
                table: "Units",
                columns: new[] { "Id", "Code", "Name" },
                values: new object[] { new Guid("33333333-3333-3333-3333-333333333333"), "ADET", "Adet" });

            migrationBuilder.InsertData(
                table: "Warehouses",
                columns: new[] { "Id", "Name" },
                values: new object[] { new Guid("44444444-4444-4444-4444-444444444444"), "Ana Depo" });
